...
PACKAGENAME = metadata.get('package_name', 'SEDkit')
DESCRIPTION = metadata.get('description', 'Spectral energy distribution construction and analysis tools')
AUTHOR = metadata.get('author', 'Joe Filippazzo')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/hover2pi/SEDkit')
